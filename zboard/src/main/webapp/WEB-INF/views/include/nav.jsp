...
<div id="nav" class="navbar navbar-inverse">
	<div class="container-fluid">
		<div class="navbar-header">
			<a class="navbar-brand" href="/sboard">ICIA</a>
		</div>
		<ul class="nav navbar-nav" id="menu_parent">
			<sec:authorize access="isAnonymous()">
				<li><a href="/sboard/user/find_id">아이디찾기</a></li>
				<li><a href="/sboard/user/reset_password">비밀번호 찾기</a></li>
				<li><a href="/sboard/user/join">회원가입</a></li>
				<li><a id='login' href='/sboard/user/login'>로그인</a></li>
			</sec:authorize>
          	<sec:authorize access="isAuthenticated()">
          		<li><a href='/sboard/user/read'>내정보</a></li>
